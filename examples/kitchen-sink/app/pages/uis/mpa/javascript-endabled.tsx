...
import { Component, ComponentProps, useSyncExternalStore } from "react";
...
export function JavaScriptEnabled() {
  ...
  return (
    <div className={`inline-flex items-center space-x-1 rounded text-lg`}>
      {enabled ? (
        <>
        ...
        <>
          <JavaScriptIcon className="size-8 grayscale" />
          <span>
            JavaScript is{" "}
...
function JavaScriptIcon(props: ComponentProps<"svg">) {
  return (
