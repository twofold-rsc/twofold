  ...
  return (
    <div className="flex h-full flex-col rounded-lg">
      <div className="relative flex w-full items-center justify-center rounded-t-lg bg-gray-100 px-4 py-2">
        ...
        <div className="relative mx-3 flex w-1/2 overflow-hidden rounded-md bg-gray-100 px-2.5 py-1.5 pr-12 text-center text-xs font-medium whitespace-nowrap ring ring-black/10 ring-inset">
