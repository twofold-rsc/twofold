  ...
  return (
    <div className="not-prose mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
      <Link
        ...
        className="flex aspect-[16/9] h-full w-full flex-col items-center justify-center rounded-lg ring-[0.5px] shadow ring-gray-200 transition-all ring-inset hover:-translate-y-0.5 hover:shadow-md"
      >
        <DigitalOceanIcon className="size-12" />

        <div className="mt-3 text-sm">DigitalOcean App Platform</div>
      </Link>
    </div>
  );
}
